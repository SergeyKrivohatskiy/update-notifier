...
public interface InitialMapper {
	...
	String CREATE_USER_TBL = "CREATE TABLE IF NOT EXISTS users(id BIGINT NOT NULL DEFAULT nextval('auto_id_users'), email VARCHAR(50) NOT NULL, PRIMARY KEY (id))";
	...
	String CREATE_RES_TBL = "CREATE TABLE IF NOT EXISTS resources(id bigint NOT NULL DEFAULT nextval('auto_id_res'), user_id bigint NOT NULL, url varchar(255) NOT NULL, shedule_code smallint NOT NULL, dom_path varchar(255) NOT NULL, filter varchar(255), hash integer NOT NULL, last_update timestamp NOT NULL, PRIMARY KEY (id), FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE)";
