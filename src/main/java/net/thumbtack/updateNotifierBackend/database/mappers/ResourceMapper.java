...
public interface ResourceMapper {
	...
	String ADD = "INSERT INTO resources (user_id, url, name, schedule_code, filter, last_modified, hash) VALUES (#{userId}, #{url}, #{name}, #{scheduleCode}, #{filter}, #{lastModified}, #{hash})";
